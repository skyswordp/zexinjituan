...
class APITester:
    def __init__(self):
        ...
        self.tests = [
            ...
            {'name': '21. saveReport', 'url': 'https://e68web01.itomtest.com/api/friend/report/1.0/saveReport', 'body': {'reportName': 'adults123', 'beReportName': 'user2', 'fCircleId': 1689288, 'content': 'test', 'reportReason': 'test'}},
        ]
